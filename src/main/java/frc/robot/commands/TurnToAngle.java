...
public class TurnToAngle extends CommandBase {
    ...
    public void execute() {
        ...
        angle = -1 * RobotContainer.getInstance().m_driveSub.getGyroAngle();
    ...
    public boolean isFinished() {
        if(m_goalAngle - tolerance < angle && angle < m_goalAngle + tolerance ){
            return true;

        }else{
            System.out.println(RobotContainer.getInstance().m_driveSub.getGyroAngle());
