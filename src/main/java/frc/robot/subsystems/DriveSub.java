...
private double wheelCircumference = 2 * Math.PI * 0.25; //r = 0.25 ft (6 in)
private double encoderResolution = 4096; //rev thru-bore encoder
private double inPerFt = 12;//12 in / 1 ft
private double distancePerPulse = ((wheelCircumference / encoderResolution) / inPerFt); //inches travelled per pulse for drivetrain
