...
private double encoderResolution = 2048; //rev thru-bore encoder
private double distancePerPulse = wheelCircumference / encoderResolution; //inches travelled per pulse for drivetrain
...
right2 = new TalonSRX(3);
 ...
 driveRightEncoder = new Encoder(5, 6, true, EncodingType.k4X);
