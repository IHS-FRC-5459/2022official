...
// Create some buttons
    ...
    */
    ...
    MoveIntake intakePivotUp = new MoveIntake(-0.75);
    MoveIntake intakePivotDown = new MoveIntake(0.65);
    ...
    ClimberPivot pivotUp = new ClimberPivot(0.9);
    ClimberPivot pivotDown = new ClimberPivot(-0.2);
    JoystickButton pivotClimberUpButton = new JoystickButton(xboxClimber, 2);
    pivotClimberUpButton.whileActiveContinuous(pivotUp);
    pivotClimberUpButton.cancelWhenPressed(pivotDown);

    JoystickButton pivotClimberDownButton = new JoystickButton(xboxClimber, 1);
    pivotClimberDownButton.whileActiveContinuous(pivotDown);
    pivotClimberDownButton.cancelWhenPressed(pivotUp);
