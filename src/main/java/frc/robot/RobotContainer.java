...
// Create some buttons
    ...
    Vision lampOn = new Vision(m_driveSub, "enable");
    Vision lampOff = new Vision(m_driveSub, "disable");
    ...
    lampOnButton.whenPressed(lampOn);
    lampOffButton.whenPressed(lampOff);
